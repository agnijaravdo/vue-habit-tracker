...
<template>
  <div class="py-4 gap-2 font-medium flex items-center justify-between">
    <Button icon="pi pi-angle-left" aria-label="Previous week" @click="store.currentWeekOffset--" />
    ...
    <Button icon="pi pi-angle-right" aria-label="Next week" @click="store.currentWeekOffset++" />
  </div>
</template>
